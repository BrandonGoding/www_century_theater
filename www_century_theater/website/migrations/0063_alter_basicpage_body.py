...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('website', '0062_contactpage_canonical_url_contactpage_og_image_and_more'),
    ]
